...
***************************************************************************
v2p食用说明：
1.打开app进入提现页面，选择对应金额，点击立即提现（不管当日是否已经提现，都能抓），到变量中查看到有zq_withdraw即可
2.注意多账号用户抓包zq_withdraw时需要与zq_cookie账号顺序一致
3.zq_cash不填默认0.3元，填的话有0.3，30两个选项（boxjs订阅中可直接修改，没有订阅的话直接新建变量即可）
4.zq_withdraw务必与zq_cash金额一致，即修改zq_withdraw时也要修改zq_cash
****************************************************************************
青龙食用说明：
1.自己抓包数据
